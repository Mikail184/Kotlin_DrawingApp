...
class DrawingView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private fun setUpDrawing() {
        ...
        // Obsolete because we set the brushsize in the function SetSizeForBrush
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action) {
            ...
            MotionEvent.ACTION_MOVE -> { mDrawPath!!.lineTo(touchX, touchY) // Add a line from the last point to the specified point (x,y).
            }
